...
class TestSudoku(unittest.TestCase):
    ...
    def test_finding_all_possiblities_for_all_spaces(self):
        ...
        self.assertEquals(puzzle.find_all_possibilities(),
                          {(0, 1): [6, 9], (0, 3): [2, 6], (0, 5): [2, 6, 9], (0, 7): [8],
                           (1, 0): [7], (1, 1): [1, 6, 7], (1, 2): [1, 2, 7], (1, 3): [2, 6, 7], (1, 5): [2, 4, 6, 7],
                           (1, 7): [1, 3], (1, 8): [1, 3, 5],
                           (2, 0): [7, 8, 9], (2, 1): [1, 7, 9], (2, 3): [7], (2, 6): [1, 8],
                           (3, 1): [1, 4, 7, 9], (3, 2): [1, 7, 8], (3, 3): [1, 3, 8], (3, 4): [4], (3, 5): [1, 4, 8],
                           (3, 8): [1, 3, 8, 9],
                           (4, 0): [4, 8], (4, 2): [1, 8], (4, 6): [1, 3, 8], (4, 8): [1, 3, 8],
                           (5, 0): [7, 8, 9], (5, 3): [1, 2, 6, 8], (5, 4): [6], (5, 5): [1, 2, 6, 8],
                           (5, 6): [1, 7, 8], (5, 7): [1, 7, 8, 9],
                           (6, 2): [7], (6, 5): [1, 6, 7], (6, 7): [1, 3, 7], (6, 8): [1, 3],
                           (7, 0): [3, 4, 7], (7, 1): [4, 5, 7], (7, 3): [1, 5, 7, 8], (7, 5): [1, 7, 8],
                           (7, 6): [1, 3, 7, 8], (7, 7): [1, 3, 4, 7, 8, 9], (7, 8): [1, 3, 8, 9],
